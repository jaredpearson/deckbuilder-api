...
public class Main {
	...
	/**
	 * Factory for creating instances of {@link Injector}
	 * @author jared.pearson
	 */
	public static class InjectorFactory {
		
		/**
		 * Creates the injector instance used for starting the application.
		 */
		public @Nonnull Injector createAppInjector() {
	...
	private static class RunCommandRunnable implements Command.CommandRunnable {
		@Override
		public void run(String[] args) throws Exception {
			final InjectorFactory injectorFactory = new InjectorFactory();
			final HttpServer httpServer = injectorFactory.createAppInjector().getInstance(HttpServer.class);
	...
	private static class DbInitCommandRunnable implements Command.CommandRunnable {
		...
		public void run(String[] args) throws Exception {
			final InjectorFactory injectorFactory = new InjectorFactory();
			final DatabaseService dbService = injectorFactory.createAppInjector().getInstance(DatabaseService.class);
